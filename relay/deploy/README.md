...
- DNS: `deck-relay.devfellowship.com` → IP da VPS.
...
- `VITE_WS_URL=wss://deck-relay.devfellowship.com/ws`
...
`DECK_RELAY_URL=wss://deck-relay.devfellowship.com npx tsx server/agent.ts --pair=CÓDIGO`,
