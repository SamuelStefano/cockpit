...
export type ServerMsg =
  ...
  | { t: 'send-reject'; sessionKey: string; reason: 'ctx-hard' | 'ctx-ceiling' | 'quota-insufficient' | 'cold-busy'; text: string; msgId?: string; message: string; ctxTokens: number; pctOfWindow: number }
