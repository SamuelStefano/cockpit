...
export function CanvasHud({ sessions, running, onPick }: Props) {
  ...
  const live = sessions.filter((s) => !s.id.startsWith('new-'));
  ...
  return (
    <div className="absolute right-3 top-3 z-10 w-64 rounded-2xl border border-neutral-700/80 bg-neutral-900/85 shadow-xl backdrop-blur-md">
