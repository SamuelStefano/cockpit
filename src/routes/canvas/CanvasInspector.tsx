...
export function CanvasInspector(p: Props) {
  ...
  return (
    <aside className="absolute bottom-16 left-3 top-3 z-10 flex w-72 flex-col overflow-hidden rounded-2xl border border-neutral-700/80 bg-neutral-900/90 shadow-xl backdrop-blur-md">
