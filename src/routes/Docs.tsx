...
import { SECTIONS, FILEMAP, RESOURCES, SLASH, KEYS, FEATURES, type IconName } from './docs.data';
...
// do backend: é manual de uso, sempre disponível mesmo offline. Os textos vivem
// em docs.data.ts — aqui fica só o layout/render.
