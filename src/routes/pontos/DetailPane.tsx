...
export function DetailPane({ selection, waiting, projects, invoices, op, ask, ledger, stale = false, syncedAt }: Props) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1100px]">
      ...
      {selecting && <SelectionBar projects={projects} stale={stale} syncedAt={syncedAt} />}
    </div>
  );
}
