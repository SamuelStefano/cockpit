  ...
  return (
    <div>
      <div className="mb-3 flex flex-wrap items-center gap-2">
        <p className="min-w-0 flex-1 basis-56 text-[12px] leading-snug text-neutral-500">
          Cada task que o agente fecha vira uma linha aqui, com o valor real. Total: <span className="tabular-nums text-neutral-300">{fmtPts(total)} pt</span>.
        </p>
