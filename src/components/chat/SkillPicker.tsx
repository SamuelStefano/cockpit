    ...
    <div ref={wrapRef} className="relative inline-flex">
      ...
      {open && (
        <>
          ...
          <div role="dialog" aria-label="Escolher skills" className="fixed inset-x-0 bottom-0 z-40 max-h-[70dvh] rounded-t-2xl border border-neutral-700 bg-neutral-900 shadow-xl shadow-black/50 sm:absolute sm:bottom-full sm:left-0 sm:inset-x-auto sm:mb-2 sm:max-h-80 sm:w-72 sm:rounded-lg">
