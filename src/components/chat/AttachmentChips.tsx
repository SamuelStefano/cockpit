...
export function AttachmentChips({ attachments, onRemoveAttachment }: AttachmentChipsProps) {
  return (
    <div className="mb-2 flex flex-wrap gap-1.5">
      {attachments.map((a) => (
        <span key={a.path} className="flex items-center gap-1.5 rounded-lg border border-neutral-700 bg-neutral-800/60 py-1 pl-1.5 pr-1 text-[11px] text-neutral-300">
