...
export function TurnStat({ stats }: { stats?: TurnStats }) {
  ...
  return (
    <span
      ...
      // Secondary data: gives its room to the session title in a narrow header.
      className="hidden items-center gap-1 rounded-md border border-neutral-800 bg-neutral-950 px-1.5 py-0.5 text-[10.5px] tabular-nums text-neutral-400 @min-[36rem]:flex"
    >
