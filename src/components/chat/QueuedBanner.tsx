          ...
          return (
            <li key={i} className="flex items-start gap-1">
              ...
              <div className="flex shrink-0 items-center">
                <button onClick={() => onMove(i, -1)} disabled={i === 0} title="Subir na fila" className={iconBtn}>
                  <Icon name="chevronUp" size={12} />
                </button>
                <button onClick={() => onMove(i, 1)} disabled={i === queued.length - 1} title="Descer na fila" className={iconBtn}>
