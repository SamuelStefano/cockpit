...
export function CockpitApp() {
  ...
  const {
    ...
    queue, queueAdd, queueRemove, queueEdit, queueMove, queueClear, queuePaused, queueSetPaused, queueRetry, queueRunBg, queueForce,
