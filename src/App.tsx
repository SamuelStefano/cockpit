...
export function CockpitApp() {
  ...
  const {
    ...
    messages, phase, running, draft, setDraft, conn, rate, stats, mode, setMode, model, setModel, effort, setEffort, budget, setBudget, slashCommands, term,
  ...
  return (
    <div className="relative flex h-full flex-col bg-neutral-950">
      ...
      {route === '/contextos' ? (
        ...
        <MobileLayout
          sessionsProps={{ sessions, loading, activeId: activeSessionId, onSelect: setActiveSessionId, onNew: handleNew, onRename: handleRename, onClose: handleCloseSession, archived, onUnhide: handleUnhide, usage, running, searchResults, onSearch }}
        ...
        <div ref={rowRef} className="flex min-h-0 flex-1">
          <div style={{ width: `${leftW}%` }} className="min-w-0 shrink-0 border-r border-neutral-800">
            <SessionsPanel sessions={sessions} loading={loading} activeId={activeSessionId}
              ...
              archived={archived} onUnhide={handleUnhide} usage={usage} running={running} searchResults={searchResults} onSearch={onSearch} />
          </div>
