...
export function CockpitApp() {
  ...
  const {
    ...
    messages, phase, terminalBusy, running, stalled, updated, runStart, draft, setDraft, conn, authRequired, agentOnline, submitToken, rate, planUsage, stats, mode, setMode, caps, claudeReady, bypass, setBypass, model, setModel, models, onRefreshModels, selectedSkills, setSelectedSkills, slashCommands, term, discoveredTerms, listTerms,
