...
export type Route = '/' | '/contextos' | '/skills' | '/notas' | '/pontos' | '/crons' | '/uso' | '/graph' | '/canvas' | '/harness' | '/admin' | '/docs' | '/ds' | '/play';

const ROUTES: Route[] = ['/', '/contextos', '/skills', '/notas', '/pontos', '/crons', '/uso', '/graph', '/canvas', '/harness', '/admin', '/docs', '/ds', '/play'];
