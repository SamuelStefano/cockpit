...
export type IncidentKind = 'silent-death' | 'orphan-resume' | 'run-error' | 'resume-exhausted' | 'reaped' | 'parked-requeue-cap' | 'parked-lock-timeout' | 'parked-resume-morto' | 'parked-migrate-reject' | 'cascade-escalation';
